          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/auth/homepage" className="flex items-center group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-bold tracking-[0.2em] text-[#C5A059] dark:text-[#FFD700] uppercase">
                  Rise of Kingdoms
                </span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-1">
                  ...
                  <Link 
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${
                      isActive
                        ...
                        : 'text-slate-600 dark:text-white hover:text-slate-900 dark:hover:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5'
                    }`}
                  >
                    {route.name}
                  </Link>
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className={`dropdown-trigger flex items-center px-4 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${
                    activeDropdown === 'more'
                      ? 'text-slate-900 dark:text-white bg-slate-100 dark:bg-white/10'
                      : 'text-slate-600 dark:text-white hover:text-slate-900 dark:hover:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5'
                  }`}
                >
                  <span>More</span>
                  <svg className={`w-4 h-4 ml-1 transition-transform ${activeDropdown === 'more' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {navbarRoutes.filter(route => ['giveaway', 'forms', 'donation', 'youtube', 'blog', 'laws'].includes(route.path)).map((route) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <span className="block text-sm font-bold text-slate-700 dark:text-white group-hover:text-slate-900 dark:group-hover:text-gray-200">
                              {route.name}
                            </span>
                          </div>
                        </Link>
              ...
              <button
                ...
                className="p-2 rounded-lg text-slate-500 dark:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-colors"
              >
            ...
            <div className="flex items-center lg:hidden space-x-4">
              ...
              <button
                ...
                className="p-2 rounded-lg text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-colors"
              >
                  ...
                  <Link
                    ...
                    className={`flex items-center px-4 py-3 rounded-xl transition-all duration-200 ${
                      isActive 
                        ...
                        : 'text-slate-600 dark:text-white hover:bg-slate-50 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-gray-200'
                    }`}
                  >
                    ...
                    <div>
                      <span className="block font-bold text-sm">{route.name}</span>
                      <span className="text-xs opacity-70">{route.description || 'View page'}</span>
                    </div>
                  </Link>
                );
              })}
