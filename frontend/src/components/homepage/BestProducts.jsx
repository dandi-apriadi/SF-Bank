    ...
    return (
        <div className="mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="absolute inset-0">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-50/50 via-white to-blue-50/50 
                    dark:from-indigo-950/30 dark:via-navy-900 dark:to-blue-950/30" />
            ...
            <div className="relative text-center mb-16 space-y-8">
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <div className="w-4 h-1.5 bg-gradient-to-r from-violet-500 to-blue-500 rounded-full" />
                        <div className="w-8 h-1.5 bg-gradient-to-r from-green-600 to-blue-500 rounded-full" />
                    </div>
